...
const ModuleCardsLarge: FC<FlightCardProps> = ({ className = '', data, setnext, openModal }) => {
        ...
        {isLoading ? (
          ...
          expandedTopics
            ...
            .map((item: any, index: any) => (
              ...
              >
                <div className='flex flex-row items-center space-y-2 dark:border-neutral-800 sm:flex-row sm:items-center sm:space-y-0'>
                  <div className='flex-shrink-0'>
                    <DocumentIcon className='h-6 w-6' />
                  </div>
                  <div className='min-w-[300px] flex-[0] cursor-pointer lg:block'>
  ...
  return (
    ...
    >
      <div className={` relative  ${className}`}>
        ...
        <span
          className={`absolute right-0 bottom-0 mt-4 flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-neutral-50 dark:bg-neutral-800 sm:bottom-auto sm:top-1/2 sm:-translate-y-1/2 ${
